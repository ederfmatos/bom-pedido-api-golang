...
func (repository *ShoppingCartRedisRepository) Upsert(context context.Context, shoppingCart *entity.ShoppingCart) error {
...
func (repository *ShoppingCartRedisRepository) FindByCustomerId(context context.Context, id string) (*entity.ShoppingCart, error) {
