...
import (
	...
	"bom-pedido-api/internal/infra/http/shopping_cart/add_item_to_shopping_cart"
	"bom-pedido-api/internal/infra/http/shopping_cart/checkout_shopping_cart"
	"bom-pedido-api/internal/infra/http/shopping_cart/delete_item_from_shopping_cart"
	"bom-pedido-api/internal/infra/http/shopping_cart/delete_shopping_cart"
	"bom-pedido-api/internal/infra/http/shopping_cart/get_shopping_cart"
...
func ConfigureRoutes(server *echo.Group, applicationFactory *factory.ApplicationFactory) {
	...
	shoppingCartRoutes.DELETE("/me", delete_shopping_cart.Handle(applicationFactory))
}
