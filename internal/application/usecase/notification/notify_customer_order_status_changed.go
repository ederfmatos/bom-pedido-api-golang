...
type (
	NotifyCustomerOrderStatusChangedUseCase struct {
		orderRepository                repository.OrderRepository
		customerNotificationRepository repository.CustomerNotificationRepository
		notificationRepository         repository.NotificationRepository
	}

	NotifyCustomerOrderStatusChangedInput struct {
		OrderId string
	}
)

func NewNotifyCustomerOrderStatusChanged(factory *factory.ApplicationFactory) *NotifyCustomerOrderStatusChangedUseCase {
	return &NotifyCustomerOrderStatusChangedUseCase{
...
func (u *NotifyCustomerOrderStatusChangedUseCase) Execute(ctx context.Context, input NotifyCustomerOrderStatusChangedInput) error {
...
func (u *NotifyCustomerOrderStatusChangedUseCase) getNotification(order *entity.Order) (string, string) {
